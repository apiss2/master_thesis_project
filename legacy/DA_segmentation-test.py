...
from src.training.DAtester import DAsegmentationTester
# utils
...
if __name__ == '__main__':
    ...
    # evaluate
    logs_A = tester_A.run(test_loader)
    logs_B = tester_B.run(test_loader)

    for logs, modality, tester in zip([logs_A, logs_B], ['A', 'B'], [tester_A, tester_B]):
